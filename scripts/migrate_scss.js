...
const PROJECT_ROOT = '/Users/nivetharamdev/Projects/lavoro-ai-ferri/frontend/src';
...
function walkDir(dir, callback) {
  fs.readdirSync(dir).forEach(f => {
    ...
    if (isDirectory) {
      ...
      if (dirPath.endsWith('.scss') && !dirPath.endsWith('base.scss') && !dirPath.endsWith('index.scss')) {
        callback(dirPath);
      }
    }
  });
